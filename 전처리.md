...
**month feature**
- month_sin: <img src="https://latex.codecogs.com/gif.latex?\sin(\frac{2\pi \ \times \ month}{12}) month_cos: \cos(\frac{2\pi \ \times \ month}{12}) " /> 
- 성수기 
- 기타 
...
**hour, minute feature**
- time_sin: <img src="https://latex.codecogs.com/gif.latex?60\sin(\frac{2\pi \ \times \ hour}{24}) + sin(\frac{2\pi \ \times \ minute}{60}) time_cos: 60\cos(\frac{2\pi \ \times \ hour}{24}) + cos(\frac{2\pi \ \times \ minute}{60}) " />
